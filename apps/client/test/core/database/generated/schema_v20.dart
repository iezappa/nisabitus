...
class FocusSounds extends Table with TableInfo<FocusSounds, FocusSoundsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  FocusSounds(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  FocusSoundsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return FocusSoundsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  FocusSounds createAlias(String alias) {
    return FocusSounds(attachedDatabase, alias);
  }
...
class FocusSoundsData extends DataClass implements Insertable<FocusSoundsData> {
  final String id;
  final int updatedAt;
  final String name;
  final String url;
  const FocusSoundsData({
    required this.id,
    required this.updatedAt,
    required this.name,
    required this.url,
  ...
  factory FocusSoundsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FocusSoundsData copyWithCompanion(FocusSoundsCompanion data) {
    return FocusSoundsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('FocusSoundsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('name: $name, ')
          ..write('url: $url')
...
class FocusSoundsCompanion extends UpdateCompanion<FocusSoundsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<String> name;
  ...
  FocusSoundsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       url = Value(url);
  static Insertable<FocusSoundsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<String>? name,
...
class DatabaseAtV20 extends GeneratedDatabase {
  ...
  late final FocusSounds focusSounds = FocusSounds(this);

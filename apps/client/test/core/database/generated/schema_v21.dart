...
class BoardColumns extends Table
    with TableInfo<BoardColumns, BoardColumnsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<int> countsAsDone = GeneratedColumn<int>(
    'counts_as_done',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (counts_as_done IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  BoardColumnsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class BoardColumnsData extends DataClass
    implements Insertable<BoardColumnsData> {
  final String id;
  final int updatedAt;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['counts_as_done'] = Variable<int>(countsAsDone);
    return map;
  }
  ...
  factory BoardColumnsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return BoardColumnsData(
      ...
      countsAsDone: serializer.fromJson<int>(json['countsAsDone']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'countsAsDone': serializer.toJson<int>(countsAsDone),
    };
  }

  BoardColumnsData copyWith({
    String? id,
    int? updatedAt,
    String? projectId,
    String? name,
  ...
  BoardColumnsData copyWithCompanion(BoardColumnsCompanion data) {
    return BoardColumnsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('BoardColumnsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
...
class BoardColumnsCompanion extends UpdateCompanion<BoardColumnsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  ...
  BoardColumnsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       position = Value(position);
  static Insertable<BoardColumnsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (countsAsDone.present) {
      map['counts_as_done'] = Variable<int>(countsAsDone.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class TodoTasks extends Table with TableInfo<TodoTasks, TodoTasksData> {
  ...
  late final GeneratedColumn<String> columnId = GeneratedColumn<String>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL REFERENCES board_columns(id)ON DELETE RESTRICT',
  );
  late final GeneratedColumn<String> projectId = GeneratedColumn<String>(
    'project_id',
    aliasedName,
...
class TaskChecklistItems extends Table
    with TableInfo<TaskChecklistItems, TaskChecklistItemsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TaskChecklistItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TaskChecklistItemsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TaskChecklistItemsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  TaskChecklistItems createAlias(String alias) {
    return TaskChecklistItems(attachedDatabase, alias);
  }
...
class TaskChecklistItemsData extends DataClass
    implements Insertable<TaskChecklistItemsData> {
  final String id;
  final int updatedAt;
  final String taskId;
  final String content;
  ...
  factory TaskChecklistItemsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TaskChecklistItemsData copyWith({
    String? id,
    int? updatedAt,
    String? taskId,
    String? content,
  ...
  TaskChecklistItemsData copyWithCompanion(TaskChecklistItemsCompanion data) {
    return TaskChecklistItemsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      taskId: data.taskId.present ? data.taskId.value : this.taskId,
  ...
  @override
  String toString() {
    return (StringBuffer('TaskChecklistItemsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('taskId: $taskId, ')
          ..write('content: $content, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TaskChecklistItemsData &&
          other.id == this.id &&
          other.updatedAt == this.updatedAt &&
          other.taskId == this.taskId &&
          other.content == this.content &&
...
class TaskChecklistItemsCompanion
    extends UpdateCompanion<TaskChecklistItemsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<String> taskId;
  final Value<String> content;
  ...
  TaskChecklistItemsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       content = Value(content),
       position = Value(position);
  static Insertable<TaskChecklistItemsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<String>? taskId,
    Expression<String>? content,
...
class FoodEntryItems extends Table
    with TableInfo<FoodEntryItems, FoodEntryItemsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  FoodEntryItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> entryId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES food_entries(id)ON DELETE CASCADE',
  );
  late final GeneratedColumn<String> name = GeneratedColumn<String>(
    'name',
    aliasedName,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  FoodEntryItemsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return FoodEntryItemsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  FoodEntryItems createAlias(String alias) {
    return FoodEntryItems(attachedDatabase, alias);
  }
...
class FoodEntryItemsData extends DataClass
    implements Insertable<FoodEntryItemsData> {
  final String id;
  final int updatedAt;
  ...
  factory FoodEntryItemsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FoodEntryItemsData copyWithCompanion(FoodEntryItemsCompanion data) {
    return FoodEntryItemsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('FoodEntryItemsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
...
class FoodEntryItemsCompanion extends UpdateCompanion<FoodEntryItemsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  ...
  FoodEntryItemsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       grams = Value(grams),
       position = Value(position);
  static Insertable<FoodEntryItemsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
...
class FoodsData extends DataClass implements Insertable<FoodsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['carbs_per100g'] = Variable<int>(carbsPer100g);
    map['fat_per100g'] = Variable<int>(fatPer100g);
    map['is_built_in'] = Variable<int>(isBuiltIn);
    return map;
  }
...
class FoodsCompanion extends UpdateCompanion<FoodsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isBuiltIn.present) {
      map['is_built_in'] = Variable<int>(isBuiltIn.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class Disciplines extends Table with TableInfo<Disciplines, DisciplinesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Disciplines(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DisciplinesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  Disciplines createAlias(String alias) {
    return Disciplines(attachedDatabase, alias);
  }
...
class DisciplinesData extends DataClass implements Insertable<DisciplinesData> {
  final String id;
  final int updatedAt;
  final String name;
  final int scheduledDate;
  ...
  factory DisciplinesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DisciplinesData copyWithCompanion(DisciplinesCompanion data) {
    return DisciplinesData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('DisciplinesData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('name: $name, ')
          ..write('scheduledDate: $scheduledDate, ')
...
class DisciplinesCompanion extends UpdateCompanion<DisciplinesData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<String> name;
  final Value<int> scheduledDate;
  ...
  DisciplinesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       scheduledDate = Value(scheduledDate),
       durationMinutes = Value(durationMinutes);
  static Insertable<DisciplinesData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<String>? name,
    Expression<int>? scheduledDate,
...
class StepLogs extends Table with TableInfo<StepLogs, StepLogsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StepLogs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  StepLogsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return StepLogsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  StepLogs createAlias(String alias) {
    return StepLogs(attachedDatabase, alias);
  }
...
class StepLogsData extends DataClass implements Insertable<StepLogsData> {
  final String id;
  final int updatedAt;
  final int steps;
  final int date;
  ...
  StepLogsData copyWith({String? id, int? updatedAt, int? steps, int? date}) =>
      StepLogsData(
        id: id ?? this.id,
        updatedAt: updatedAt ?? this.updatedAt,
  ...
  StepLogsData copyWithCompanion(StepLogsCompanion data) {
    return StepLogsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('StepLogsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('steps: $steps, ')
          ..write('date: $date')
...
class StepLogsCompanion extends UpdateCompanion<StepLogsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  ...
  StepLogsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       steps = Value(steps),
       date = Value(date);
  static Insertable<StepLogsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
...
class StepGoals extends Table with TableInfo<StepGoals, StepGoalsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StepGoals(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  StepGoalsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return StepGoalsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  StepGoals createAlias(String alias) {
    return StepGoals(attachedDatabase, alias);
  }
...
class StepGoalsData extends DataClass implements Insertable<StepGoalsData> {
  final String id;
  final int updatedAt;
  final int steps;
  const StepGoalsData({
  ...
  factory StepGoalsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  StepGoalsData copyWith({String? id, int? updatedAt, int? steps}) =>
      StepGoalsData(
        id: id ?? this.id,
        updatedAt: updatedAt ?? this.updatedAt,
        steps: steps ?? this.steps,
      );
  StepGoalsData copyWithCompanion(StepGoalsCompanion data) {
    return StepGoalsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      steps: data.steps.present ? data.steps.value : this.steps,
  ...
  @override
  String toString() {
    return (StringBuffer('StepGoalsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('steps: $steps')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StepGoalsData &&
          other.id == this.id &&
          other.updatedAt == this.updatedAt &&
          other.steps == this.steps);
}

class StepGoalsCompanion extends UpdateCompanion<StepGoalsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<int> steps;
  final Value<int> rowid;
  ...
  static Insertable<StepGoalsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<int>? steps,
    Expression<int>? rowid,
...
class HydrationGoalsData extends DataClass
  ...
  HydrationGoalsData copyWith({String? id, int? updatedAt, int? millilitres}) =>
      HydrationGoalsData(
        id: id ?? this.id,
        updatedAt: updatedAt ?? this.updatedAt,
...
class VacationPeriods extends Table
    with TableInfo<VacationPeriods, VacationPeriodsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VacationPeriods(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  VacationPeriodsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return VacationPeriodsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  VacationPeriods createAlias(String alias) {
    return VacationPeriods(attachedDatabase, alias);
  }
...
class VacationPeriodsData extends DataClass
    implements Insertable<VacationPeriodsData> {
  final String id;
  final int updatedAt;
  final int startDate;
  final int? endDate;
  final String? note;
  const VacationPeriodsData({
    required this.id,
    required this.updatedAt,
  ...
  factory VacationPeriodsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  VacationPeriodsData copyWithCompanion(VacationPeriodsCompanion data) {
    return VacationPeriodsData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      startDate: data.startDate.present ? data.startDate.value : this.startDate,
  ...
  @override
  String toString() {
    return (StringBuffer('VacationPeriodsData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('startDate: $startDate, ')
          ..write('endDate: $endDate, ')
...
class VacationPeriodsCompanion extends UpdateCompanion<VacationPeriodsData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<int> startDate;
  final Value<int?> endDate;
  ...
  VacationPeriodsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       updatedAt = Value(updatedAt),
       startDate = Value(startDate);
  static Insertable<VacationPeriodsData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<int>? startDate,
    Expression<int>? endDate,
...
class AudioTracks extends Table with TableInfo<AudioTracks, AudioTracksData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AudioTracks(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> usage = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'FOCUS\'',
    defaultValue: const CustomExpression('\'FOCUS\''),
  );
  @override
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AudioTracksData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  AudioTracks createAlias(String alias) {
    return AudioTracks(attachedDatabase, alias);
  }
...
class AudioTracksData extends DataClass implements Insertable<AudioTracksData> {
  final String id;
  final int updatedAt;
  final String name;
  final String url;
  ...
  factory AudioTracksData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AudioTracksData copyWithCompanion(AudioTracksCompanion data) {
    return AudioTracksData(
      id: data.id.present ? data.id.value : this.id,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('AudioTracksData(')
          ..write('id: $id, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('name: $name, ')
          ..write('url: $url, ')
...
class AudioTracksCompanion extends UpdateCompanion<AudioTracksData> {
  final Value<String> id;
  final Value<int> updatedAt;
  final Value<String> name;
  ...
  AudioTracksCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       url = Value(url);
  static Insertable<AudioTracksData> custom({
    Expression<String>? id,
    Expression<int>? updatedAt,
    Expression<String>? name,
...
class DatabaseAtV21 extends GeneratedDatabase {
  ...
  late final TaskChecklistItems taskChecklistItems = TaskChecklistItems(this);
  late final NutritionGoals nutritionGoals = NutritionGoals(this);
  late final FoodEntries foodEntries = FoodEntries(this);
  late final FoodEntryItems foodEntryItems = FoodEntryItems(this);
  ...
  late final Disciplines disciplines = Disciplines(this);
  late final StepLogs stepLogs = StepLogs(this);
  late final StepGoals stepGoals = StepGoals(this);
  ...
  late final VacationPeriods vacationPeriods = VacationPeriods(this);
  late final AudioTracks audioTracks = AudioTracks(this);

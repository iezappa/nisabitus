...
class RoutinesData extends DataClass implements Insertable<RoutinesData> {
  ...
  RoutinesData copyWith({int? id, String? name, int? startDate, int? weeks}) =>
      RoutinesData(
        id: id ?? this.id,
        name: name ?? this.name,
        startDate: startDate ?? this.startDate,
  ...
  @override
  int get hashCode => Object.hash(id, name, startDate, weeks);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class RoutineExercises extends Table
    with TableInfo<RoutineExercises, RoutineExercisesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  RoutineExercisesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return RoutineExercisesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
...
class RoutineExercisesData extends DataClass
    implements Insertable<RoutineExercisesData> {
  final int id;
  final int routineId;
  final int exerciseId;
  ...
  factory RoutineExercisesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  RoutineExercisesData copyWithCompanion(RoutineExercisesCompanion data) {
    return RoutineExercisesData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('RoutineExercisesData(')
          ..write('id: $id, ')
...
class RoutineExercisesCompanion extends UpdateCompanion<RoutineExercisesData> {
  final Value<int> id;
  ...
  RoutineExercisesCompanion.insert({
    ...
    this.notes = const Value.absent(),
       ...
       exerciseId = Value(exerciseId),
       weekdays = Value(weekdays);
  static Insertable<RoutineExercisesData> custom({
    Expression<int>? id,
...
class DatabaseAtV9 extends GeneratedDatabase {
  ...
  late final Index routineByStart = Index(
    'routine_by_start',
    'CREATE INDEX routine_by_start ON routines (start_date)',
  );
  late final Index routineExerciseByRoutine = Index(
    'routine_exercise_by_routine',
    'CREATE INDEX routine_exercise_by_routine ON routine_exercises (routine_id)',
  );

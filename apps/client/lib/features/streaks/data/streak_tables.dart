...
class Streaks extends Table with RecordColumns {
...
class StreakHistoryEntries extends Table with RecordColumns {
  TextColumn get streakId =>
      text().references(Streaks, #id, onDelete: KeyAction.cascade)();

...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String backupCsvExported(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'CSV guardado: $count registros',
      one: 'CSV guardado: 1 registro',
    );
    return '$_temp0';
  }
  ...
  @override
  String get deleteFailed => 'No se pudo borrar. Intentá de nuevo.';
  ...
  @override
  String get dashboardActivityLess => 'Menos';

  @override
  String get dashboardActivityMore => 'Más';

  @override
  String dashboardActivityDays(int days) {
    return '$days días con actividad';
  }
